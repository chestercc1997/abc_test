...
typedef struct GiaDetectingResults {
    Vec_Int_t *xor2_list;
    Vec_Int_t *xor3_list;
...
extern GiaDetectingResults *Gia_detecting_ha_fa(Gia_Man_t * pGia) ;
extern void Gia_free_detecting_results(GiaDetectingResults *results);
